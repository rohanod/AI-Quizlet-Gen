...
export default function FlashcardDisplay({ flashcards, isStreaming = false }: FlashcardDisplayProps) {
  ...
  return (
    <div className="flex flex-col gap-8 pb-32 w-full max-w-[2000px] mx-auto" ref={containerRef}>
      <div className="grid grid-cols-[repeat(auto-fill,300px)] gap-6 w-full justify-center">
        <AnimatePresence initial={false}>
          {flashcards.map((card, index) => (
            <motion.div
              ...
              className="w-[300px] h-[240px] bg-card rounded-xl border shadow-lg overflow-hidden flex flex-col"
            >
        ...
        {isStreaming && (
          <motion.div 
            ...
            className="w-[300px] h-[240px] rounded-xl bg-card/30 border shadow-lg flex items-center justify-center"
          >
